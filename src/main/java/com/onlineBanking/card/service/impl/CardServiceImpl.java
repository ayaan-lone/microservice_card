...
public class CardServiceImpl implements CardService {
	...
	@Override
	public String createCard(CreateCardRequestDto createCardRequestDto, Long userId) throws CardApplicationException {
	...
	public String handleDebitCardTransaction(long userId, long cardNumber, CardType cardTypeEnum, long amount)
	...
	private String handleCreditCardTransaction(long userId, long cardNumber, CardType cardTypeEnum, long amount,
			Card card) throws CardApplicationException {
